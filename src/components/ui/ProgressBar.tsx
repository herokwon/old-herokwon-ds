    ...
    (percent === 0 ? (
      ...
      >
        <progress
          value={percent}
          max={100}
          className="h-5 w-full appearance-none overflow-x-hidden rounded-full progress-bar:bg-light-secondary progress-value:rounded-full progress-value:bg-light-blue dark:progress-bar:bg-dark-secondary dark:progress-value:bg-dark-blue"
        />
      </div>
    ))
  );
